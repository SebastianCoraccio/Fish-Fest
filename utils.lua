...
function utils.hexToRGB(hexCode)
  ...
  return tonumber("0x" .. hexCode:sub(1, 2)) / 255, tonumber("0x" .. hexCode:sub(3, 4)) / 255, tonumber(
    "0x" .. hexCode:sub(5, 6)
  ) / 255
end
...
function utils.beginsWithVowel(str)
  local firstLetter = string.sub(string.lower(str), 1, 1)
